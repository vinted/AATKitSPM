...
#import "SMACMPPublisherVendors.h"
#import <SmaatoSDKCMP/SMAGDPRTypes.h>

NS_ASSUME_NONNULL_BEGIN

/**
 All properties can not be nil of this class. Publisher has to send at-least a Vendor / Custom Vendor. Otherwise a run time error will be thrown from cmpConfigurationDidFailWithError delegate method.
 */
