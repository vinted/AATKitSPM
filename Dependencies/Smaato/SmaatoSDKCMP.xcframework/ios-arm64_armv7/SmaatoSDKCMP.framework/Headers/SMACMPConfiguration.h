...
#import "SMAPublisherWelcomeScreenConfiguration.h"
...
/// A delegate to set publisher country code. The country code of the country that determines legislation of reference and is mandatory and has no default.
